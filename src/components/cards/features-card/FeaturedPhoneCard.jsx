...
const FeaturedPhoneCard = ({ image }) => {
  ...
  return (
    <div className="relative w-[300px] h-[400px] bg-slate-200 ring-1 ring-slate-300 hover:shadow-2xl duration-300 group">
      <div className="absolute w-[300px] h-[400px] p-1 group-hover:opacity-50 group-hover:bg-gray-500 transition-all duration-200">
